...
import { AlterColumnCategoryIdTaskTableRemoveNotNull1696621889256 } from './migrations/1696621889256-AlterColumnCategoryIdTaskTableRemoveNotNull';
...
export const AppDataSource = new DataSource({
    ...
    migrations: [
        ...
        AlterColumnCategoryIdTaskTableRemoveNotNull1696621889256
    ],
    subscribers: [],
})
